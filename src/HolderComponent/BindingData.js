...
export default class BindingData extends Component {
  ...
  onPressLogin = () => {
    ...
    // Hàm console.log sẽ được chạy trước, lấy kết quả   isLogin của cái "Render cũ", sau đó mọi thứ sẽ được Render lại từ đầu, và Giá trị sau RENDER RUN ở dòng 39 mới là giá trị đúng
  };
